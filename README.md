...
**Live Frontend URL:** [**https://mytrip.vercel.app**](https://mytrip.vercel.app)<br>**Live Backend URL:** [**https://mytrip-ride-booking-system-backend.vercel.com**](https://mytrip-ride-booking-system-backend.vercel.com)
...
| Role | Email | Password |
| :--- | :--- | :--- |
| **Admin** | `admin@mytrip.com` | `Admin@1234` |
| **Driver** | `driver.mytrip@gmail.com` | `Diver@1234` |
| **Rider** | `helloworld@gmail.com` | `Rider@1234` |
...
| **UI/UX**| react-hot-toast (Notifications), recharts (Charts) |
