...
import { useCancelRideMutation, useGetRideHistoryQuery } from "@/redux/features/ride/ride.api";
...
//  { rideId: ride._id, rideStatus: values }
    ...
    toast.error(
      err instanceof Error
        ? err.message
        : (err as any)?.data?.message || "Failed to cancel ride"
    );
  }
};
