...
export function ApplicationRow({ application, onStatusUpdate, onDelete }: ApplicationRowProps) {
  return (
    <TableRow className="hover:bg-gray-50 dark:hover:bg-gray-800/50">
      ...
      <TableCell>
        <div className="space-y-1">
          ...
          {application.driver.phone && (
            <div className="text-sm text-gray-500">{application.driver.phone}</div>
          )}
        </div>
      </TableCell>
      ...
      <TableCell>
        <div className="space-y-1">
          <div className="font-medium capitalize">{application.vehicleInfo.vehicleType}</div>
          <div className="text-sm text-gray-500">{application.vehicleInfo.model}</div>
